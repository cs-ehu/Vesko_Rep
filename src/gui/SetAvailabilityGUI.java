...
private static final long serialVersionUID = 1L;
  ...
  private Owner o;
  private DefaultComboBoxModel<RuralHouse> rhs = new DefaultComboBoxModel<RuralHouse>();
	private ApplicationFacadeInterfaceWS facade = new MainGUI().getBusinessLogic();


  
  public SetAvailabilityGUI(ArrayList<RuralHouse> v, Owner o)
  {
  ...
  private void jbInit(ArrayList<RuralHouse> v,Owner o) throws Exception
  {
	System.out.println("Nombre =="+ o.getUserName());
    this.getContentPane().setLayout(null);
    this.setSize(new Dimension(513, 451));
    ...
    jComboBox1 = new JComboBox<RuralHouse>();
    jComboBox1.setModel(rhs);
    ...
    jButton2.setText(ResourceBundle.getBundle("Etiquetas").getString("SetAvailabilityGUI.jButton2.text")); //$NON-NLS-1$ //$NON-NLS-2$
